...
export const markdownRootClass =
  "font-[family-name:var(--font-family-chat)] text-[14px] leading-[22px] font-normal break-words text-[#e8e8e8] " +
  "[text-rendering:auto] [font-feature-settings:normal] " +
  "[&_p]:m-0 [&_p]:mb-3 [&_p:last-child]:mb-0 " +
  "[&_h1]:mt-4 [&_h1]:mb-2 [&_h1]:text-[16px] [&_h1]:font-[590] [&_h1]:leading-normal " +
  "[&_h2]:mt-4 [&_h2]:mb-2 [&_h2]:text-[16px] [&_h2]:font-[590] [&_h2]:leading-normal " +
  "[&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:text-[14px] [&_h3]:font-[590] [&_h3]:leading-normal " +
  "[&_h4]:mt-4 [&_h4]:mb-1.5 [&_h4]:text-[14px] [&_h4]:font-[590] [&_h4]:leading-normal " +
  "[&_h1:first-child]:mt-0 [&_h2:first-child]:mt-0 [&_h3:first-child]:mt-0 [&_h4:first-child]:mt-0 " +
  "[&_strong]:font-[590] [&_em]:italic " +
